...
* Bước 4: mở trình duyệt bất kỳ, đăng nhập vào tài khoản facebook dùng để treo bot (acc phụ). sau đó mở tiện ích trên, nhấp vào nút Export Fbstate. lúc này sẽ tải 1 file fbstate.json về máy, copy file đó vào project
